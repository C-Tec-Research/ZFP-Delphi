...
type
  ...
  private
    ...
    fOnOriginalChange : tNotifyEvent;
    fEnabled: boolean;
    fItemIndex: integer;
    fVisible : boolean;
...
begin
{
  ...
  if assigned( fComboBox ) then
  begin
    fComboBox.OnChange := fOnOriginalChange;
    fComboBox := nil;
  end
  else if assigned( fRadioGroup ) then
  begin
    fRadioGroup.OnClick := fOnOriginalChange;
    fRadioGroup := nil;
  end;
  ...
  begin
    ...
    fOnOriginalChange := fComboBox.OnChange;
  ...
  begin
    ...
    fOnOriginalChange := fRadioGroup.OnClick;
