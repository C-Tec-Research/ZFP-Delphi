...
var
  ...
  iModuleName : array [0..255] of char;
  iProcName : array [0..255] of char;
begin
  if not Assigned(P) then
  begin
    strPcopy( iModuleName, ModuleName );
    ModuleHandle := GetModuleHandle( @iModuleName );
    ...
    strPCopy( iProcName, ProcName );
    P := Pointer(GetProcAddress(ModuleHandle, @ProcName));
    if not Assigned(P) then
