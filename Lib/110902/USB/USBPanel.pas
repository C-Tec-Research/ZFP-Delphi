...
//           FT_Open( i, iUSBHandle )) then
        begin
          ...
          begin
            ...
            StrCopy( fActualManufacturer, fDefaultManufacturer );
            StrCopy( fActualManufacturerID, fDefaultManufacturerID );
            StrCopy( fActualDescription, fDefaultDescription );
            StrCopy( fActualSerialNo, fDefaultSerialNo );
      ...
      try
        ...
        begin
          ...
          begin
            ...
            begin
              if (fOpenMethod = omByID) or (AnsiStrComp( fProgramSerialNo, fActualSerialNo ) = 0) then
              begin
                // done
                fOpen := TRUE;
                fDeviceNo := i;
...
begin
  if fOpen then
  begin
    StrCopy( iManufacturer, fActualManufacturer );
  end
  else
  begin
    StrCopy( iManufacturer, fProgramManufacturer );
  end;
  Result := '';
...
begin
  if fOpen then
  begin
    StrCopy( iManufacturerID, fActualManufacturerID );
  end
  else
  begin
    StrCopy( iManufacturerID, fProgramManufacturerID );
  end;
  Result := '';
...
begin
  if fOpen then
  begin
    StrCopy( iDescription, fActualDescription );
  end
  else
  begin
    StrCopy( iDescription, fProgramDescription );
  end;
  Result := '';
...
begin
  ...
  if fOpen then
  begin
    StrCopy( iSerialNo, fActualSerialNo );
  end
  else
  begin
    StrCopy( iSerialNo, fProgramSerialNo );
  end;
