...
(*
  TFrameHolder = class( TPanel )
  {
    A specialised variant of TPanel specifically designed for
...
*)
  ...
  protected
    ...
    procedure CalculateDimensions( pMin, pOptimal, HostSize : single; var Count : integer; var Size : single );
...
procedure TSigFrameGrid.CalculateDimensions(pMin, pOptimal, HostSize: single;
...
begin
  ...
  begin
    ...
    begin
      ...
      CalculateDimensions( MinFrameWidth, OptFrameWidth, Width, iColCount, iCellWidth);
      if iColCount = 0 then
      begin
        exit;
      end;
