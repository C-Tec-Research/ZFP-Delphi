...
type
  ...
  tSigSpecialBooleanProperty = class( tSigBooleanProperty )
  private
    fDefaultValue: boolean;
    function GetValueAsDefaultableBool: tDefaultableBool;
    procedure SetValueAsDefaultableBool(const Value: tDefaultableBool);
    {  Used to move from a Defaultable boolean property to a standard one }
  protected
    function GetValueAsBool: boolean; override;
    procedure SetValueAsBool(const pValue: boolean); override;
  public
...
{ tSigSpecialBooleanProperty }

function tSigSpecialBooleanProperty.GetValueAsBool: boolean;
begin
  Result := inherited;
end;

function tSigSpecialBooleanProperty.GetValueAsDefaultableBool: tDefaultableBool;
begin
  if ValueAsBool then
  begin
    Result := db_TRUE;
...
procedure tSigSpecialBooleanProperty.SetValueAsBool(const pValue: boolean);
begin
  inherited;

end;

procedure tSigSpecialBooleanProperty.SetValueAsDefaultableBool(
  const Value: tDefaultableBool);
begin
  case Value of
    db_Default:
    begin
      ValueAsBool := DefaultValue;
    end;
    db_FALSE:
    begin
      ValueAsBool := FALSE;
