...
type
  ...
  TOnDBExceptionTranslate = function ( const pVar : string ) : string of object;

  ESigDBException = class( Exception )
  public
  ...
  private
    ...
    class function GetOnTranslate: TOnDBExceptionTranslate; static;
    class procedure SetOnTranslate(const Value: TOnDBExceptionTranslate); static;
  protected
  ...
  public
    ...
    class property OnTranslate : TOnDBExceptionTranslate
          read GetOnTranslate
          write SetOnTranslate;
...
var
  fOnTranslate : TOnDBExceptionTranslate;

function Translate( const pVar : string ) : string;
begin
  if assigned( fOnTranslate ) then
  begin
    Result := fOnTranslate( pVar );
  end
  else
  begin
    Result := pVar;
...
class function TSigDBHelper.GetOnTranslate: TOnDBExceptionTranslate;
begin
  Result := fOnTranslate;
end;
...
class procedure TSigDBHelper.SetOnTranslate(
  const Value: TOnDBExceptionTranslate);
begin
  fOnTranslate := Value;
end;
...
constructor ESigDBException.Create(const Msg: string);
begin
