...
{$ENDIF}
  ...
  tStringListControlList = class( TTypedObjectList<tStringListControl> )
  private
  ...
  public
    constructor Create; reintroduce;
    procedure RegisterControl( const pControl : TWinControl; const pChangesActiveChild : boolean );
...
{$ENDIF}
  public
    ...
    procedure Delete( const pIndex : integer ); overload;
    procedure Reindex;
    property ClearRemovesChildren : boolean
             read fClearRemovesChildren
             write fClearRemovesChildren;
...
procedure tStringListControlList.RegisterControl(const pControl: TWinControl; const pChangesActiveChild : boolean);
var
  i: Integer;
begin
  // avoid duplicates
  ...
  i := Add( TStringListControl.Create( pControl, pChangesActiveChild ));
  if pChangesActiveChild then
  begin
    Item[ i ].OnIndexChange :=  self.OnIndexChange;
  end;
end;
