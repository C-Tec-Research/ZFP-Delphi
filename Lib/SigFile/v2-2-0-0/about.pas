...

{
  ...
  v1.1.0.0  Separate First/Next generation from Find. Add two extra types in
            Find Col (First, Next) to accomodate, and add extra entities
            automatically for backward compatibility.
  v2.0.0.0  Start to move to Tree View
  v2.1.0.1  Tree View completed
  v2.2.0.0  Introduction of BLOB and LAST field types.
}
{
