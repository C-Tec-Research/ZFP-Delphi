...

{
  ...
  private
    ...
    procedure SetVisibleRoot(const Value: tSigDBIndex);
  protected
    procedure ShowCurrentFields; override;
              { override to set the visual editors from the field values }
    procedure SetCurrentFields; override;
...
procedure TSigDBIndexFileVCLHelper.SetCurrentFields;
begin
  inherited;
...
procedure TSigDBIndexFileVCLHelper.ShowCurrentFields;
begin
  inherited;
