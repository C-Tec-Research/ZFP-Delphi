...
function tSigFileImageList.Load(pFile: tStrings; var pLine: integer; const pAllowUndo : boolean; const pIsDirty : boolean;
...
function tSigFileImageList.PasteFromClipboard(pClipboard: tStrings;
