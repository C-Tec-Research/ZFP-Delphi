...
begin
  ...
  begin
    ...
    case self.fCompareStyle.ValueAsStyle of
      ...
      cs_Set_Membership: iLine := '    else raise exception.Create(''Invalid Set Comparison with Text'');'; // this form not valid in data files
      else               exit;
    end;
    Add( iLine );
  end;
      ...
      case Filter.ValueAsSigDBFieldType of
        ...
        begin
          ...
          begin
            ...
            Add( '      case self.FieldType of' );
            Add( '        ft_Filter_in:' );
            Add( '        begin' );
            Add( '          // leave as is' );
            Add( '        end;' );
            Add( '        ft_Filter_not_in:' );
            Add( '        begin' );
            Add( '          // invert' );
            Add( '          Result := not Result;' );
            Add( '        end' );
            Add( '        else' );
            Add( '        begin' );
            Add( '          raise TSigDBException.Create(''Unexpected Field Validity request'');' );
            Add( '        end;' );
            Add( '      end;' );
            Add( '      Read( iSaveRec );' );
            Add( '    finally' );
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Add( '    Add( ' + iFieldString + '.Create( Fields, ' + Filter.ValueToTypeText + ', T'+ DataFile.BaseFileName.Value +'Data.c' + DBBField.DBBField.FieldName.Value + ' ));' );
        end
        else
        begin
