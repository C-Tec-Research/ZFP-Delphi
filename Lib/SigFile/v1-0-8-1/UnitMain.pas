...
uses
  ...
  UnitFiles, StdCtrls,
  SigFilePgmStatus, SigPanel, Vcl.ComCtrls, SigGeneralGrid, Vcl.Grids,
  Vcl.Samples.Spin, SigSpinEdit, Vcl.CheckLst;
...
type
  TFormMain = class(TForm)
    ...
    SigPanel4: TSigPanel;
    SigPanel5: TSigPanel;
    MemoDatabaseSource: TMemo;
    SpeedButtonBuildDBSource: TSpeedButton;
    ...
    SigGridEditorFirst: TSigGridEditor;
    SigGridEditorFindKeyCount: TSigGridEditor;
    ...
    procedure SpeedButtonBuildDBSourceClick(Sender: TObject);
...
procedure TFormMain.BuildDatabaseSource;
begin
  fSigFile.BuildDBSource( MemoDatabaseSource.Lines );
  {
  MemoDatabaseSource.Clear;
  with MemoDatabaseSource.Lines do
  begin
...
procedure TFormMain.ClearSources;
begin
  MemoDatabaseSource.Clear;
end;
...
begin
  ...
  PageControlMain.ActivePage := TabSheetDetails;
  {
...
procedure TFormMain.SpeedButtonBuildDBSourceClick(Sender: TObject);
begin
  fSigFile.BuildDBSource( MemoDatabaseSource.Lines );
end;
