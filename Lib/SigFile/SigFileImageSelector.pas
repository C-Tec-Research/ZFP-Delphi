...
uses
  ...
  ImgList,
  //SigNET.TStringGrid,
  SigFileImageList, Menus, ExtDlgs, System.ImageList;
...
type
  TFormImageSelector = class(TForm)
    ...
    StringGridUserImages: TStringGrid;
...
var
  iIndex : integer;
begin
  iIndex := (ARow * StringGridUserImages.ColCount) + ACol;
  with StringGridUserImages.Canvas do
  begin
    Brush.Color := clWhite;
    Pen.Color := clWhite;
...
var
  ARow, ACol : integer;
begin
  StringGridUserImages.MouseToCell( X, Y, ACol, ARow );
  fSelIndex := (ARow * StringGridUserImages.ColCount) + ACol;
end;
...
begin
  StringGridUserImages.MouseToCell( X, Y, ACol, ARow );
  iSelIndex := (ARow * StringGridUserImages.ColCount) + ACol;
  ...
  begin
    ...
    StringGridUserImages.Invalidate;
  end;
end;
