...
type
  TFrameIconEditor = class(TFrame)
    ...
    SigNETStringGridMain: TSigNETStringGrid;
...
begin
  ...
  begin
    ...
    SigNETStringGridMain.Invalidate;
  end;
end;
...
begin
  iCellIndex := ARow * SigNETStringGridMain.ColCount + ACol;
  iTab := TabControlClasses.TabIndex;
  if iTab < 0 then
  begin
    // should not get here
    with SigNETStringGridMain do
    begin
