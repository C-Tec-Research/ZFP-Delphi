...
type
  ...
  tSigFileUndoAction = ( undoClearUndoList, undoValue, undoChangeMax, undoCreate,
                         undoInsert, undoDelete, undoSelPos, undoSelLen,
  ...
  public
    ...
    function Error( pErrorList : tErrorList = nil ) : boolean; virtual;
  ...
  public
    ...
    function Error( pErrorList : tErrorList = nil ) : boolean;
...
function tSigBaseProperty.Error(pErrorList: tErrorList): boolean;
begin
  Result := FALSE;
end;
...
function tSigPropertyList.Error(pErrorList: tErrorList): boolean;
var
  i: Integer;
begin
  Result := FALSE;
  for i := 0 to Count - 1 do
  begin
    if Item[ i ].Error( pErrorList ) then
    begin
      Result := TRUE;
    end;
