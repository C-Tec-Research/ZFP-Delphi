...
begin
  ...
  begin
    ...
    begin
      if assigned( Owner ) then
      begin
        if not Owner.EditorInhibited then
        begin
  ...
  case iLoadingFromDevice of
    ...
    begin
      ...
      begin
        ...
        if not (fUndoing or Creating or LoadingFromFile) then
        begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        iIgnoreChild.Load( pFile, pLine, pErrors );
...
begin
  ...
  begin
    fAfterLoadList := tObjectList.Create;
  end;
...
begin
  if SigNETParse ( fValue, SigProperty,
           SigIndex, SigValue, SigComment) then
  begin
    fDestinationObject := fDestinationList.FindChild( SigProperty, SigIndex );
  end
  else
  begin
    fDestinationObject := nil;
  end;
end;
...
function tSigPointer.Load(pFile: tStrings; var pLine: integer;
  pErrors: tErrorList): boolean;
var
  iOwner : tSigCompoundProperty;
begin
