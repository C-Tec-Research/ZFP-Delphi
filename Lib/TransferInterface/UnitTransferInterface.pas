...
type
  ...
  private
    ...
    function GetReceiveData(const i : Cardinal): byte;
  ...
  public
    ...
    property ReceiveData[ const i : Cardinal ] : byte   // starts after record type. RecordType = 0, true data = 1
             read GetReceiveData;
  ...
  // published
    ...
    property LastSentChecksum : DWord
             read fLastChecksum;
  end;
...
function tTransferInterface.GetReceiveData(const i : Cardinal): byte;
begin
...
var
  ...
  pRecSizePos, pCSPos, pBreakPos : Cardinal;
  pRecSize, pCSSize, pCSError : Cardinal;
  pLostCount : integer;
  iCS : integer;
  iRecSize : integer;
  iByte : byte;
